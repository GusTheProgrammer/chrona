 ...
 *     description: |
 *       Uploads files to a specified S3 bucket based on the file type. Supports images and documents with specific size restrictions and file type validations.
 *     parameters:
 *       - in: query
 *         name: type
 *         required: true
 *         description: Specifies the type of the file to upload, either 'image' or 'document'.
 *         schema:
 *           type: string
 *           enum: [image, document]
 *     requestBody:
 ...
 *     responses:
 *       200:
 *         description: File uploaded successfully. Returns URLs of the uploaded files.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *       400:
 *         description: Invalid file type or file does not meet the specified criteria.
 *       500:
 *         description: Internal server error or issues with the file upload process.
 */
